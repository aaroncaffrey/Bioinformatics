...
namespace BioinformaticsHelperLibrary.ProteinDataBankFormat.RecordTypes
{
    ...
    [Serializable]
    public class HETATM_Record : ProteinDataBankFileRecord
    {
        [Description(""), Category("Data")]
        public HETATM_Field HETATM;
        ...
        [Description("Orthogonal coordinates for X."), Category("Data")]
        public x_Field x;

        [Description("Orthogonal coordinates for Y."), Category("Data")]
        public y_Field y;

        [Description("Orthogonal coordinates for Z."), Category("Data")]
        public z_Field z;
        ...
        [Serializable]
        public class HETATM_Field : ProteinDataBankFileRecordField
        {
            public new const int FirstColumn = 1;
            public new const int LastColumn = 6;
            public new const string DataType = "Record name";
            public new const string Definition = "";
            public new const string FieldName = "HETATM";


            public HETATM_Field(string columnFormatLine)
        ...
        public class x_Field : ProteinDataBankFileRecordField
        {
            ...
            public new const string Definition = "Orthogonal coordinates for X.";
        ...
        public class y_Field : ProteinDataBankFileRecordField
        {
            ...
            public new const string DataType = "Real(8.3)";
            public new const string Definition = "Orthogonal coordinates for Y.";
        ...
        public class z_Field : ProteinDataBankFileRecordField
        {
            ...
            public new const string DataType = "Real(8.3)";
            public new const string Definition = "Orthogonal coordinates for Z.";
