...
{
    // The code in the Excel** class files contain modified methods of classes/methods taken from MSDN
    public class ExcelSheets
    {
        // Given a document name and text, 
        // inserts a new work sheet and writes the text to cell "A1" of the new worksheet.

        public static void InsertText(SpreadsheetDocument spreadSheet, WorksheetPart worksheetPart, Cell cell, string text)
        {
